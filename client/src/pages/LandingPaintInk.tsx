...
const painPoints = [
  "High media wear contaminates pigment color and affects product quality",
  "Inconsistent particle size distribution leads to coating defects",
  "Frequent media replacement increases production downtime and costs",
  "Difficulty achieving nano-scale particle sizes for advanced formulations",
];

const solutions = [
  "Ultra-low wear rate (<0.01%) virtually eliminates contamination concerns",
  "Tight size distribution ensures consistent grinding results batch after batch",
  "3–5× longer lifespan vs. glass beads reduces total cost of ownership",
  "Available in 0.1–0.3 mm for nano-grinding down to <100 nm",
];

const recommendedSizes = [
  { range: "0.1 – 0.3 mm", use: "Nano pigments, advanced coatings" },
  { range: "0.3 – 0.6 mm", use: "Standard pigments, printing inks" },
  { range: "0.6 – 1.0 mm", use: "Coarse grinding, primers" },
];
        ...
        <div className="container relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeUp} className="max-w-2xl">
            ...
            <p className="text-white/70 leading-relaxed mb-8">
              Achieve superior pigment dispersion and nano-grinding performance with our high-density 95% YSZ zirconia beads. Designed for paint, coating, and ink production lines.
            </p>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start gap-2.5">
                <input type="checkbox" id="agree-paint" checked={agreeTerms} onChange={(e) => setAgreeTerms(e.target.checked)} required className="mt-1 w-4 h-4 rounded border-graphite-300" />
                <label htmlFor="agree-paint" className="text-xs text-graphite-500 leading-relaxed">
